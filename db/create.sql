...
insert into products (name, description, code, aantal_blz, price) values ('De Avonturen Van Pinokkio', 'Uit een wonderlijk stuk hout dat wel lijkt te leven, snijdt Gepetto een marionet. Hij noemt hem Pinokkio, en wil hem liefdevol opvoeden als zijn eigen zoon. Maar de onnozele Pinokkio zit vol streken en gaat ervandoor om van het ene avontuur in het andere verzeild te raken. Hij laat zich misleiden door de sluwe Vos en Kat, wordt bijna vermoord, verandert in een ezel, komt in Luilekkerland terecht en belandt in de buik van een reusachtige haai..... Om uiteindelijk terug te keren en een échte zoon voor Gepetto te zijn.Dit boek bevat het complete klassieke verhaal over de wereldberoemde marionet, in een eigentijdse vertaling, en met fantastische tekeningen van Jan Jutte.', '492662523-7', 144, 14);
insert into products (name, description, code, aantal_blz, price) values ('De Da Vinci Code', 'In Parijs loopt Robert Langdon, hoogleraar kunstgeschiedenis en symboliek, een afspraak met de conservator van het Louvre mis; deze blijkt kort daarvoor te zijn vermoord. Voor de politie is Langdon de belangrijkste verdachte: voordat de man stierf schreef hij namelijk de woorden zoek Robert Langdon op de grond. Geholpen door agente Sophie Neveu maakt Langdon zich uit de voeten. Hij beseft dat de conservator aanwijzingen heeft achtergelaten die alleen hij kan ontcijferen: symbolen die verwijzen naar het werk van Leonardo Da Vinci. Met Neveu begint hij een speurtocht naar het motief van de moord. Maar de politie en de moordenaar zitten hun op de hielen...', '816905633-0', 445, 10.5);
insert into products (name, description, code, aantal_blz, price) values ('Harry Potter En De Geheime Kamer', 'Na een verschrikkelijke vakantie bij zijn gemene oom en tante gaat Harry Potter naar de tweede klas van Zweinsteins Hogeschool voor Hekserij en Hocus-Pocus. Maar alleen al om daar te komen blijkt een ware heksentoer te zijn, waarbij een vliegende auto Harry en zijn vriend Ron uitkomst biedt. Na alle avonturen van vorig schooljaar denkt Harry zich rustig aan zijn lessen Toverdranken, Verweer tegen de Zwarte Kunsten en zijn favoriete sport Zwerkbal te kunnen wijden. Maar dan hoort hij een mysterieuze stem, vinden er aanslagen plaats en ontdekt hij een wel heel bijzonder dagboek...', '816905633-0', 256, 10.5);
insert into products (name, description, code, aantal_blz, price) values ('Harry Potter En De Gevangene Van Azkaban', 'Sirius Zwarts, een beruchte volgeling van Voldemort, is uit de gevangenis van Azkaban ontsnapt en heeft het wellicht op Harry gemunt. Harry is inmiddels aan een enerverend schooljaar begonnen met nieuwe vakken als Dreuzelkunde en zorg voor Fabeldieren, spannende Zwerkbalwedstrijden en griezelige voorspellingen. De school wordt bewaakt door Dementors, de gevreesde bewakers van Azkaban, en Harry zal zijn lessen Verweer tegen de Zwarte Kunsten hard nodig hebben.', '816905633-0', 326, 10.5);
insert into products (name, description, code, aantal_blz, price) values ('Harry Potter En De Vuurbeker', 'Zoals ieder jaar brengt Harry Potter de zomervakantie door bij zijn vreselijke oom en tante, waar de sfeer dit jaar extra gespannen is doordat hun verwende zoontje Dirk op dieet is. Harry kan dan ook niet wachten tot hij terug mag naar Zweinsteins Hogeschool voor Hekserij en Hocus-Pocus, om aan zijn vierde schooljaar te beginnen.', '816905633-0', 552, 10.5);
